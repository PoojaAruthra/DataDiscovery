...
exports.config = {
  ...
  chromeDriver: process.env.SELENIUM_URL ? null : (process.env.CHROMEDRIVER || require('chromedriver').path),
  framework: 'jasmine',
  jasmineNodeOpts: {
    showColors: true,
  ...
  onPrepare() {
    ...
    jasmine.getEnv().addReporter(new JUnitXmlReporter({
      filePrefix: 'test-e2e',
      savePath: require('path').join(__dirname, '../dist/reports/angular-frontend')
    }));
  }
};
